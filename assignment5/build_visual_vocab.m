...
[clust_centroids, ~] = kmeans(double(feat_descriptor_matrix)', nr_of_clusters); % NB: apparently this Matlab built-in only works if nr_of_clusters is smaller than the amount of data... So this would break if we do 1000 or 4000 clusters or even already at 400... Probably need to implement k-means ourselves.
