...
feature_descriptor_matrix = extractFeatures(x_subset_vocab_learning, opt_opponent, opt_dense); 
...
x_train_hists = represent_by_histograms(x_train, visual_dictionary, opt_opponent, opt_dense);
